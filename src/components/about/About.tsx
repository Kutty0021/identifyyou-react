        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="text-lg text-gray-400 mb-8 leading-relaxed space-y-2 list-disc pl-5">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="border-l-4 border-primary pl-4">
                  ...
                  <p className="text-sm text-gray-400 font-medium">Enterprise Clients</p>
                </div>
                <div className="border-l-4 border-primary pl-4">
                  <p className="text-3xl font-bold text-white mb-1">100%</p>
                  <p className="text-sm text-gray-400 font-medium">Delivery Success</p>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="relative aspect-square w-full rounded-2xl shadow-lg overflow-hidden mt-8 border border-[#333]">
                <Image
                  src={image1}
              ...
              <div className="relative aspect-square w-full rounded-2xl shadow-lg overflow-hidden border border-[#333]">
                <Image
                  src={image2}
              ...
              <div className="relative aspect-square w-full rounded-2xl shadow-lg overflow-hidden mt-4 border border-[#333]">
                <Image
      ...
      <section className="py-20 bg-[#121212] border-t border-[#333]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#0a0a0a] p-8 rounded-xl shadow-lg border border-[#333] hover:border-gray-500 transition-all duration-300">
              <div className="w-14 h-14 bg-[#1a1a1a] text-primary border border-[#333] rounded-lg flex items-center justify-center mb-6">
            ...
            <div className="bg-[#0a0a0a] p-8 rounded-xl shadow-lg border border-[#333] hover:border-gray-500 transition-all duration-300">
              ...
              <h4 className="text-xl font-bold text-white mb-3">Client Partnership</h4>
              <p className="text-gray-400 leading-relaxed">
