...
export const metadata = {
  ...
  description: "Comprehensive Smart Mobility solutions driving digital transformation and operational excellence.",
};

export default function SmartMobilityPage() {
  const pageData = data.find(p => p.slug === 'smart-mobility');
    ...
    <div className="flex flex-col min-h-screen bg-[#1a1a1a]">
      ...
      <div className="bg-[#121212] py-20 border-b border-[#333]">
        <div className="max-w-[1200px] mx-auto px-5">
          <h1 className="text-4xl md:text-5xl font-bold text-white text-center mb-4">{pageData?.title || "Smart Mobility"}</h1>
        </div>
      </div>
