...
export const metadata = {
  ...
  description: "A comprehensive suite of technology solutions designed to accelerate growth.",
};

export default async function SolutionsPage() {
  let cards: WPSolution[] = [];
  let pageTitle = "Our Solutions";
  
  try {
    const pageData = await getPageBySlug('solutions');
    if (pageData) {
      pageTitle = pageData.title.rendered || "Our Solutions";
    }
    cards = await getPageCards('solutions');
  } catch (err) {
    console.error("Error loading solutions page:", err);
  }
