...
export const metadata = {
  ...
  description: "Comprehensive CRM Implementation, Integration, and Customization.",
};

export default async function CrmSolutionsPage() {
  let cards: WPSolution[] = [];
  let error = null;

  try {
    cards = await getSolutions('crm');
  } catch (err) {
    console.error("Error loading CRM solutions:", err);
    error = "Failed to load CRM solutions dynamically.";
  }

  return (
    <div className="flex flex-col min-h-screen bg-black">
      <PageHeader title="CRM Solutions" />
