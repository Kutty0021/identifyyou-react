...
export const metadata = {
  ...
  description: "Comprehensive CRM Implementation, Integration, and Customization to drive customer success.",
};

export default function CrmSolutionsPage() {
  const pageData = getPageDataBySlug('crm-solutions');
    ...
    <div className="flex flex-col min-h-screen bg-[#1a1a1a]">
      ...
      <div className="bg-[#121212] pt-[80px] pb-20 border-b border-[#333]">
        <div className="max-w-[1200px] mx-auto px-5 mt-10">
          <h1 className="text-[40px] md:text-[50px] font-extrabold text-white text-center mb-4 tracking-tight">CRM Solutions</h1>
          <p className="text-[18px] md:text-[20px] text-gray-400 text-center max-w-3xl mx-auto leading-relaxed">
            Comprehensive CRM Implementation, Integration, and Customization to drive customer success.
          </p>
        </div>
      </div>
