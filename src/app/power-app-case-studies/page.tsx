...
export const metadata = {
  title: "Power Apps Case Studies | Identifyyou",
  description: "Accelerate Innovation with Microsoft PowerApps.",
};

export default function PowerAppCaseStudiesPage() {
  const pageData = getPageDataBySlug('power-app-case-studies');
    ...
    <div className="flex flex-col min-h-screen bg-[#1a1a1a]">
      ...
      <div className="bg-[#121212] pt-[80px] pb-20 border-b border-[#333]">
        <div className="max-w-[1200px] mx-auto px-5 mt-10">
          <h1 className="text-[40px] md:text-[50px] font-extrabold text-white text-center mb-4 tracking-tight">Power Apps Case Studies</h1>
          <p className="text-[18px] md:text-[20px] text-gray-400 text-center max-w-3xl mx-auto leading-relaxed">
            Accelerate Innovation with Microsoft PowerApps.
          </p>
        </div>
      </div>
