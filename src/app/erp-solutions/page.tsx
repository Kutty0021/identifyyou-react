...
export default function Page() {
  const pageData = data.find(p => p.slug === 'erp-solutions');
  const title = pageData?.title || "ERP Solutions";
    ...
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Streamline operations and unify data with customized enterprise resource planning systems.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="prose prose-lg text-gray-600">
                {topCapabilities.length > 0 ? topCapabilities.map((cap, i) => (
                  ...
                  <>
                    <p className="mb-6 leading-relaxed">We specialize in implementing and customizing robust ERP solutions to bring your entire business operations—from finance and supply chain to HR and manufacturing—under one unified system.</p>
                    <p className="mb-6 leading-relaxed">Our approach focuses on deep process mapping to ensure your ERP system aligns perfectly with your operational reality, reducing silos and driving organizational efficiency.</p>
                  </>
                )}
              </div>
            </div>
              ...
              <ul className="space-y-4">
                {listCapabilities.length > 0 ? listCapabilities.map((cap, i) => (
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700 font-medium">Business process mapping and re-engineering</span>
                  </li>
                )}
              </ul>
            </div>
      ...
      <section className="py-20 bg-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Streamline Your ERP Systems?</h2>
