...
export const metadata = {
  ...
  description: "Transform Your Data into Actionable Insights with MS Power BI.",
};

export default function PowerBiCaseStudiesPage() {
  const pageData = getPageDataBySlug('power-bi-case-studies');
    ...
    <div className="flex flex-col min-h-screen bg-[#1a1a1a]">
      ...
      <div className="bg-[#121212] pt-[80px] pb-20 border-b border-[#333]">
        <div className="max-w-[1200px] mx-auto px-5 mt-10">
          <h1 className="text-[40px] md:text-[50px] font-extrabold text-white text-center mb-4 tracking-tight">Power BI Case Studies</h1>
          <p className="text-[18px] md:text-[20px] text-gray-400 text-center max-w-3xl mx-auto leading-relaxed">
            Transform Your Data into Actionable Insights with MS Power BI.
          </p>
        </div>
      </div>
